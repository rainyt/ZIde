...
class ApplicationMain
{
	...
	public static function main()
	{
		...
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("ZIde-UI", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["name"] = "ZIde";
		app.meta["packageName"] = "cc.zygame.zide";
	...
	macro public static function getEntryPoint()
	{
		...
		switch (Context.follow(Context.getType("UIStart")))
		{
			case TInst(t, params):
				...
				if (hasMain)
				{
					return Context.parse("@:privateAccess UIStart.main()", Context.currentPos());
				}
				...
				{
					Context.fatalError("Main class \"UIStart\" has neither a static main nor a constructor.", Context.currentPos());
				}

			default:

				Context.fatalError("Main class \"UIStart\" isn't a class.", Context.currentPos());
		}
...
@:keep @:dox(hide) class DocumentClass extends UIStart {}
#else
class DocumentClass
{
