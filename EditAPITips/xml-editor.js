...
var TipsPool = function() {
	...
	haxe_Log.trace("classes=",{ fileName : "TipsPool.hx", lineNumber : 46, className : "TipsPool", methodName : "new", customParams : [this.classes]});
	haxe_Log.trace("attartMaps=",{ fileName : "TipsPool.hx", lineNumber : 47, className : "TipsPool", methodName : "new", customParams : [this.attartMaps == null ? "null" : haxe_ds_StringMap.stringify(this.attartMaps.h)]});
};
...
TipsPool.prototype = {
	extendsClass: function(item,c) {
		...
		var ec = this.xmlItemMaps.h[c];
		if(ec.exists("class")) {
			this.extendsClass(item,ec.get("class"));
		}
	}
	,__class__: TipsPool
};
...
XmlEditorContent.prototype = {
	provideCompletionItems: function(model,position,context,token) {
		...
		if(leftInput.indexOf("</") == 0) {
			...
			return this.returnSuggestions(this.filterSuggestions(position,sym,content,this.tipsPool.classes.slice()));
		} else if(sym == " ") {
			...
			if(classFount.indexOf("\"") == -1 && Object.prototype.hasOwnProperty.call(this.tipsPool.attartMaps.h,classFount)) {
